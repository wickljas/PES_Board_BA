...
#define RGB_LED_RED   PB_8
#define RGB_LED_GREEN PB_9
#define RGB_LED_BLUE  PB_10 
...
void set_rgb_led_color(int color_num, FastPWM &rgb_led_red, FastPWM &rgb_led_green, FastPWM &rgb_led_blue); // custom function to set the RGB LED color based on the color number, definition at the end
...
int main()
{
    ...
    // RGB LED
    FastPWM rgb_led_red(RGB_LED_RED);
    FastPWM rgb_led_green(RGB_LED_GREEN);
    FastPWM rgb_led_blue(RGB_LED_BLUE);
    ...
    while (true) {
        ...
        if (do_execute_main_task) {
            ...
            // printf("Color Cal: %f %f %f %f\n", color_cal[0], color_cal[1], color_cal[2], color_cal[3]);
            // printf("Color Num: %d Color %s\n", color_num, color_string);

            set_rgb_led_color(color_num, rgb_led_red, rgb_led_green, rgb_led_blue);
...
void set_rgb_led_color(int color_num, FastPWM &rgb_led_red, FastPWM &rgb_led_green, FastPWM &rgb_led_blue)
{
    float rgb_led_red_value = 0.0f;
    float rgb_led_green_value = 0.0f;
    float rgb_led_blue_value = 0.0f;

    switch (color_num)
        {
        case 0: // UNKNOWN
            rgb_led_red_value = 1.0f;
            rgb_led_green_value = 1.0f;
            rgb_led_blue_value = 1.0f;
            /* code */
            break;
        case 1: // BLACK
            rgb_led_red_value = 1.0f;
            ...
            break;
        case 2: // WHITE
            rgb_led_red_value = 0.5f;
            rgb_led_green_value = 0.5f;
            rgb_led_blue_value = 0.5f;
            break;
        case 3: // RED
            rgb_led_red_value = 0.5f;
            rgb_led_green_value = 1.0f;
        ...
        case 8: // MAGENTA
            rgb_led_red_value = 0.5f;
            rgb_led_green_value = 1.0f;
            rgb_led_blue_value = 0.7f;
            break;
        default:
            break;
        }

        rgb_led_red = rgb_led_red_value;
        rgb_led_green = rgb_led_green_value;
        rgb_led_blue = rgb_led_blue_value;
}